...
class RoundedTabBarIndicator extends Decoration {
  ...
  Decoration? lerpFrom(Decoration? a, double t) {
    if (a is RoundedTabBarIndicator) {
      return new RoundedTabBarIndicator(
  ...
  Decoration? lerpTo(Decoration? b, double t) {
    if (b is RoundedTabBarIndicator) {
      return new RoundedTabBarIndicator(
...
class _BubblePainter extends BoxPainter {
  ...
  final RoundedTabBarIndicator decoration;
